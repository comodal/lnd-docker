...
- `0.15.2-beta`, `0.15-beta`, `latest` ([DebianDockerfile.release](https://github.com/dmp1ce/lnd-docker/blob/v0.15.2-beta/DebianDockerfile.release))
- `0.15.2-beta-alpine`, `0.15-beta-alpine`, `alpine` ([AlpineDockerfile.release](https://github.com/dmp1ce/lnd-docker/blob/v0.15.2-beta/AlpineDockerfile.release))
