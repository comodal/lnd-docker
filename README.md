...
- `0.10.0-beta`, `0.10-beta`, `latest` ([v0.10-beta/DebianDockerfile](https://github.com/dmp1ce/lnd-docker/blob/hub/v0.10-beta/DebianDockerfile))
- `0.10.0-beta-alpine`, `0.10-beta-alpine`, `alpine` ([v0.10-beta/AlpineDockerfile](https://github.com/dmp1ce/lnd-docker/blob/hub/v0.10-beta/AlpineDockerfile))
